    ...
    return (
        ...
        <div className="relative overflow-hidden bg-white pb-16">
            ...
            <div className="relative px-4 sm:px-6 lg:px-8">
                ...
                <p><span >This website is operated by UpMySalary. Throughout the site, the terms “we”, “us” and “our” refer UpMySalary. UpMySalary offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.</span></p>
                ...
                <p><span >Our store is hosted on Godaddy  They provide us with the online e-commerce platform that allows us to sell our products and services to you.</span></p>
                ...
                <p><span >Section 5 - Products or Services</span></p>
                <p><span >Certain products or services may be available exclusively online through the website. These products or services are subject to return or exchange only according to our Return Policy.</span></p>
                        
                <p><span >We have made every effort to display as accurately as possible the colors and images of our products that appear at the store. We cannot guarantee that your computer monitors display of any color will be accurate.</span></p>
                ...
                <p><span >You recognize that you are free to manage your own subscription terms at any time by logging into your Account, and you agree to the responsibility for doing so.</span></p>
                        
                <p><span >You agree that any products purchased from UpMySalary,  will be used solely for personal non-commercial use and will not be re-sold, published, loaned, or shared.</span></p>
                        
                <p><span >Digital products may be purchased and printed for personal non-commercial use only.</span></p>
                        
                <p><span >We are not liable for potential extra charges related to your order incurred after a transaction on the Site is made. Potential extra charges may include, but are not limited to: customs or duty fees, bank fees, transaction fees associated with a customers payment method.</span></p>
                        
                <p><span >You agree to pay for any and all extra charges incurred by your order. You recognize that payment of these charges may be required in order to receive your shipment. You accept that we will not reimburse you for these charges.</span></p>
                        
                <p><span >You recognize that we are not held liable for any inconveniences resulting from you failing to read or understand claims listed on the Site. Such inconveniences may include, but are not limited to: deliveries arriving later than expected due to failure to read or understand shipping estimates or policies; extra charges incurred external to a transaction on the site; unintended automatic charges incurred due to failure to manage your subscription terms.</span></p>
                        
                <p><span >You recognize that circumstances external to the control of Lavendaire,  may interfere with delivery of products or services, and accept that we are not held liable for the results of these circumstances. Such circumstances may include, but are not limited to: customs holds; local postal office policies; postal facility service disruptions related to weather, natural disasters, or worker strikes.</span></p>
                ...
                <p><span >We are not liable for any harm or damages related to the purchase or use of goods, services, resources, content, or any other transactions made in connection with any third-party websites. Please review carefully the third-partys policies and practices and make sure you understand them before you engage in any transaction. Complaints, claims, concerns, or questions regarding third-party products should be directed to the third-party.</span></p>
                        
                <p><span >Section 9 - User Comments, Feedback, and Other Submissions</span></p>
                <p><span >If, at our request, you send certain specific submissions (for example giveaway entries) or without a request from us you send creative ideas, suggestions, proposals, plans, or other materials, whether online, by email, by postal mail, or otherwise (collectively, comments), you agree that we may, at any time, without restriction, edit, copy, publish, distribute, translate and otherwise use in any medium any comments that you forward to us. We are and shall be under no obligation (1) to maintain any comments in confidence; (2) to pay compensation for any comments; or (3) to respond to any comments.</span></p>
                ...
                <p><i><span >Section 11 - Errors, Inaccuracies, and Omissions</span></i></p>
                ...
                <p><span >In addition to other prohibitions as set forth in the Terms of Service, you are prohibited from using the site or its content:</span></p>
                        
                <p><span >for any unlawful purpose</span></p>
                <p><span >to solicit others to perform or participate in any unlawful acts</span></p>
                <p><span >to violate any international, federal, provincial or state regulations, rules, laws, or local ordinances</span></p>
                <p><span >to infringe upon or violate our intellectual property rights or the intellectual property rights of others</span></p>
                <p><span >to harass, abuse, insult, harm, defame, slander, disparage, intimidate, or discriminate based on gender, sexual orientation, religion, ethnicity, race, age, national origin, or disability</span></p>
                <p><span >to submit false or misleading information</span></p>
                <p><span >to upload or transmit viruses or any other type of malicious code that will or may be used in any way that will affect the functionality or operation of the Service or of any related website, other websites, or the Internet</span></p>
                <p><span >to collect or track the personal information of others</span></p>
                <p><span >to spam, phish, pharm, pretext, spider, crawl, or scrape</span></p>
                <p><span >for any obscene or immoral purpose; or</span></p>
                <p><span >to interfere with or circumvent the security features of the Service or any related website, other websites, or the Internet.</span></p>
                <p><span >We reserve the right to terminate your use of the Service or any related website for violating any of the prohibited uses.</span></p>
                ...
                <p><span >Section 18- Refund &amp; return policy </span></p>
                        
                <p><span >All transactions for purchase of intangible products, pdf downloads, resource material, and online content are made through payment gateways such as PayPal or Stripe that use SSL encryption. These payment gateways are safe and secure for using all types of credit cards and debit cards in different countries and your details are not stored during this process.</span></p>
                        
                <p><span >Requests for a refund are accepted at <strong>support@upmysalary.com</strong></span><span > within the period of 2 week after the order is placed. You should accompany this request with detailed and grounded reasons why you are applying for a refund.</span></p>
                ...
                <p><span >Questions about the Terms of Service should be sent to us at <strong>support@upmysalary.com</strong></span><span >.</span></p>
                </div>
            </div>
        </div>
        <Footer/>
